This repository is using ReactJS, TypeScript and TailwindCSS. It also runs on node 18 (see .nvmrc). If you're running this for the first time - please ensure you have nvm (node version manager).
